...
const api: DesktopApi = {
  ...
  saveGoogleOAuthConfig: (config) => ipcRenderer.invoke("geistr:save-google-oauth-config", config) as Promise<{ ok: boolean }>,
  getGoogleOAuthConfig: () => ipcRenderer.invoke("geistr:get-google-oauth-config") as Promise<{ clientId: string; clientSecret: string }>,
